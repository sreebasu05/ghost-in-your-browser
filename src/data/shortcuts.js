...
export const SHORTCUTS = [
...

  {
    ...
    hint2: 'Option/Alt + Cmd/Ctrl + Right arrow',
...

  {
    ...
    hint2: 'Option/Alt + Cmd/Ctrl + Left arrow',
...

  {
    ...
    hint2: "Think 'U' for Underlying code",
    hint3: 'Press ⌘ + N',
