...
export const SHORTCUTS = [
...

  {
    ...
    hint2: 'No modifier key needed. Think of the biggest key...',
    hint3: 'Press Space',
...

  {
    ...
    hint2: 'Hold Shift and press the biggest key...',
...

  {
    ...
    hint2: 'No modifier key. Think of the universal cancel button...',
    hint3: 'Press Esc',
  ...
  acts: [
    {
      ...
      shortcuts: ['new_tab', 'close_tab', 'reload', 'address_bar', 'scroll_down', 'find'],
      boss: {
        name: 'The Lockdown',
